...
def play_game(board, chosen_word):
    ...
    while wrong_guesses < NUM_TRIES:
        ...
        while guess in guess_history or len(guess) != 1:
        ...
        if was_correct == False:
            ...
            print(f"You have {wrong_guesses} wrong guess(es)") 
    ...
    print(f"Number of trials is over, you lost the game :(. The word is {chosen_word}")
...
if __name__ == '__main__':
    ...
    while is_continue == True:
        ...
        if input("press C if you want to continue, any other key to quit: ").upper() == 'C':
            is_continue = True
        else:
            is_continue = False